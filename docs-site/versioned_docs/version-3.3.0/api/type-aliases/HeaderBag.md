# Type Alias: HeaderBag

> **HeaderBag** = \{ `get`: `string` \| `null`; \} \| `Record`\<`string`, `string` \| `null` \| `undefined`\>

Defined in: [src/lib/interfaces/header-bag.interface.ts:9](https://github.com/AndreaAlhena/ng-qubee/blob/dca5f28601740c09e0f530d078a305173a7b6535/src/lib/interfaces/header-bag.interface.ts#L9)
