Defined in: [src/lib/strategies/laravel-response.strategy.ts:28](https://github.com/AndreaAlhena/ng-qubee/blob/1cd6a1e62b8ad701ae642ec09bab2c3c3e467b57/src/lib/strategies/laravel-response.strategy.ts#L28)
