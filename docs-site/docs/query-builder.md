...
Filters with explicit comparison operators. Supported by API Platform, Directus, Feathers, json-server, NestJS, @nestjsx/crud, OData, PocketBase, PostgREST, Sieve, Strapi, and DRF.
